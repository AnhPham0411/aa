...
@section('main')
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/coloshop-master/styles/main_styles.css">
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/coloshop-master/styles/responsive.css">
    <div class="main_slider" style="background-image:url({{ url('/') }}/coloshop-master/images/slider_1.jpg)">
            ...
            <div class="row align-items-center fill_height">
                <div class="col">
                    <div class="main_slider_content">
                        ...
                        <div class="red_button shop_now_button"><a href="{{ route('shop', ['page' => 1]) }}">shop now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="banner_item align-items-center"
                        style="background-image:url({{ url('/') }}/coloshop-master/images/banner_1.jpg)">
                ...
                <div class="col-md-4">
                    <div class="banner_item align-items-center"
                        style="background-image:url({{ url('/') }}/coloshop-master/images/banner_2.jpg)">
                        <div class="banner_category">
                ...
                <div class="col-md-4">
                    <div class="banner_item align-items-center"
                        style="background-image:url({{ url('/') }}/coloshop-master/images/banner_3.jpg)">
                        <div class="banner_category">
                            ...
                            <div class="product-item men">
                                <div class="product discount product_filter">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_name"><a href="single.html">{{ $sanpham->Ten_sp }}</a></h6>
                                        <div class="product_price">
                                            ${{ $sanpham->Gia_moi }}<span>${{ $sanpham->Gia_cu }}</span></div>
                                    </div>
                                </div>
