            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img"
                            style="background-image: url(https://thietkenoithatxinh.vn/wp-content/uploads/decor-shop-quan-ao-nu.jpg);">
                        </div>
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="{{ route('user_post_register') }}" class="signin-form" method="POST">
                                @csrf
                            ...
                            <p class="text-center">You are a member? <a data-toggle="tab"
                                    href="{{ route('userlogin') }}">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
